...
from .latex import ROOT_DOCUMENT, LatexTools, compiles_document, uncommented
from .layout import (
    HARDY_DIR,
    LOCAL_DIR,
    LOCAL_STATE,
...
class MathematicsSession:
    ...
    def _admission_operations(self) -> AdmissionOperations:
        return AdmissionOperations(
            shape=self._assumption_shape,
            probe=self._assumption_probe,
            vacuity=self._vacuity_probe,
            refutation=self._refutation_probe,
