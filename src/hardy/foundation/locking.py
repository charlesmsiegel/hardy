"""Operating-system file locks and crash-resistant atomic byte replacement.

The descriptor owns a lock for its lifetime; a leftover rendezvous file does
not claim ownership. These operations do not depend on run storage or grading.
"""
