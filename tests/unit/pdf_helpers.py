...
def book_pages() -> list[Page]:
    ...
    return [
        Page((("Chapter 1. Groups", 72, 720), ("1.1 Subgroups", 72, 690), ("Definition 1.1. A subgroup is a subset closed under the operation.", 72, 660),
              ...
              ("Then H is generated by it. Q.E.D.", 72, 580))),
        Page((("Proposition 1.3. By Theorem 1.2, every quotient of a cyclic group is cyclic.", 72, 720),
              ("Proof. Immediate. Q.E.D.", 72, 690), ("Theorem 1.8. A gap in numbering is not evidence of missing theorems.", 72, 660))),
        Page((("Chapter 2. Rings", 72, 720), ("Lemma 2.1. Every ideal of Z is principal.", 72, 690), ("Proof. As for Theorem 1.2. Q.E.D.", 72, 660))),
    ]
